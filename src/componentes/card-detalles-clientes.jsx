...
class DetallesCardCliente extends React.Component {
  state = {
    fecha_venta: "",
  };

  componentDidMount() {
    let data_ventas_por_cliente = null;

    if (this.props.data[0] == undefined) {
      data_ventas_por_cliente = [];
    } else {
      data_ventas_por_cliente = this.props.data[0].fecha_factura;
    }
    this.setState({
      fecha_venta: data_ventas_por_cliente,
    });
  }
  ...
  render() {
    return (
      <>
        <h5 className="card-title-detalles text-center">
...
DetallesCardCliente.prototypes = {
  data: PropType.array,
...
export default connect(null, mapDispatchToProps)(DetallesCardCliente);
